...
static void bluetooth_app_send_status(void)
{
    ...
    snprintf(response, sizeof(response),
             "S,run=%d,base=%d,vl10=%ld,vr10=%ld,err=%d,far=%d,spd_err=%d,level=%d,gyro10=%ld,fps=%d,state=%d,stream=%d,draw=%d,rate=%d,baud=%lu\n",
...
static void bluetooth_app_send_telemetry(void)
{
    ...
    snprintf(telemetry, sizeof(telemetry),
             "B,t=%lu,run=%d,b=%d,tl10=%ld,tr10=%ld,vl10=%ld,vr10=%ld,e=%d,ef=%d,se=%d,sl=%d,g10=%ld,yr10=%ld,fps=%d,fms=%d,st=%d,cr=%u,zb=%d\n",

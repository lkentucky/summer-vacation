...
int main(void) {
  ...
  while (1) {
    ...
    static uint8 frame_mid_filtered = STEER_CENTER_COL; // 本帧只更新一次中线滤波，显示直接复用结果。
    ...
    case STEP_STEER:
      ...
      frame_mid_filtered = mid_line_weighted_average();
      steering_set_image_error((int16)frame_mid_filtered - STEER_CENTER_COL,
    ...
    case STEP_DISPLAY:
      ...
      ips200_show_int(32, 256, (int)frame_mid_filtered, 3);
